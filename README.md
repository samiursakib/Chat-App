This is a chatting app written in React & Redux with create-react-app. It receives given username and password only to keep the simiplicity. You can register as a new user to use this app.
